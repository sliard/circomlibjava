...
public class BabyJubTest {
    ...
    public void packPointUnpackPointOne() {
        ...
        assertEquals("53b81ed5bffe9545b54016234682e7b2f699bd42a5e9eae27ff4051bc698ce85", new BigInteger(res1).toString(16));
    ...
    public void packPointUnpackPointTwo() {
        ...
        BabyJub babyJub = new BabyJub();
        byte[] res1= babyJub.packPoint(p);
        assertEquals("e114eb17eddf794f063a68fecac515e3620e131976108555735c8b0773929709", new BigInteger(res1).toString(16));
        PairByteArray res = babyJub.unpackPoint(res1);
    ...
    // 5ce98c61b05f47fe2eae9a542bd99f6b2e78246231640b54595febfd51eb853
    // 010111001110100110001100011000011011000001011111010001111111111000101110101011101001101001010100001010111101100110011111011010110010111001111000001001000110001000110001011001000000101101010100010110010101111111101011111111010101000111101011100001010011

    // 58f3ca45e701e74ae1f53307e4a28df57fdc039f8cba053f10569c1642f2288
    // 010110001111001111001010010001011110011100000001111001110100101011100001111101010011001100000111111001001010001010001101111101010111111111011100000000111001111110001100101110100000010100111111000100000101011010011100000101100100001011110010001010001000
