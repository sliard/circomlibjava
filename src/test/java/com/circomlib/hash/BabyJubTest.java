...
public class BabyJubTest {
    ...
    public void packPointUnpackPointOne() {
        ...
        assertEquals("53b81ed5bffe9545b54016234682e7b2f699bd42a5e9eae27ff4051bc698ce85", ByteArrayOperator.toHexString(res1));
        PairByteArray res = babyJub.unpackPoint(res1);
        assertEquals("17777552123799933955779906779655732241715742912184938656739573121738514868268", ByteArrayOperator.toString(res.l, 10));
        assertEquals("2626589144620713026669568689430873010625803728049924121243784502389097019475", ByteArrayOperator.toString(res.r,10));
    ...
    public void packPointUnpackPointTwo() {
        ...
        BabyJub babyJub = new BabyJub();
        byte[] res1= babyJub.packPoint(p);
        assertEquals("e114eb17eddf794f063a68fecac515e3620e131976108555735c8b0773929709", ByteArrayOperator.toHexString(res1));
        PairByteArray res = babyJub.unpackPoint(res1);
        assertEquals("6890855772600357754907169075114257697580319025794532037257385534741338397365", ByteArrayOperator.toString(res.l, 10));
        assertEquals("4338620300185947561074059802482547481416142213883829469920100239455078257889", ByteArrayOperator.toString(res.r,10));
    }
